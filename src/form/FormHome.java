...
public class FormHome extends javax.swing.JPanel {
    public FormHome() {
        ...
        card1.setData(new Model_Card("Staffs", "Total Staffs", 12));
        card4.setData(new Model_Card("Users", "Total Users", 65));
        card2.setData(new Model_Card("Posts", "Total Posts", 15));
        card3.setData(new Model_Card("Comments", "Total Comments", 65));
    }
