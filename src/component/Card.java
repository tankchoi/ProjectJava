...
public class Card extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        lbTitle.setText("Staff");

        lbValues.setFont(new java.awt.Font("Segoe UI", 2, 18)); // NOI18N
        lbValues.setForeground(new java.awt.Color(255, 255, 255));
        lbValues.setText("Total Staff");

        lbCount.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
